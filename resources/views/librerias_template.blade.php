...
<link rel="apple-touch-icon" sizes="72x72" href="{{asset('template/img/apple-touch-icon-72x72.png')}}">
<link rel="apple-touch-icon" sizes="114x114" href="{{asset('template/img/apple-touch-icon-114x114.png')}}">
...
<link href="{{asset('template/css/font_italic.css')}}" rel='stylesheet' type='text/css'>
<link href='{{asset('template/css/font_open_sans.css')}}' rel='stylesheet' type='text/css'>
